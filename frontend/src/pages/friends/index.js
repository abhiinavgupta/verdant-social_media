            ...
            <div className="friends">
                ...
                <div className="friends_left">
                    ...
                    <div className="friends_left_wrap">
                        ...
                        <Link to="/friends" className={`menu_item hover4 ${type === undefined && "active_friends"}`}>
                            <div className="small_circle_second">
                        ...
                        <Link to="/friends/requests" className={`menu_item hover4 ${type === "requests" && "active_friends"}`}>
                            <div className="small_circle_second">
                        ...
                        <Link to="/friends/sent" className={`menu_item hover4 ${type === "sent" && "active_friends"}`}>
                            <div className="small_circle_second">
                        ...
                        <Link to="/friends/all" className={`menu_item hover4 ${type === "all" && "active_friends"}`}>
                            <div className="small_circle_second">
